...
ggplot(mta_filtered, aes(x = Total_Ridership, fill = Transport_Mode)) +
  ...
  labs(
    ...
    caption = str_wrap("Each bar represents the number of days that fall within a given ridership range. The data illustrate that subway ridership tends to be higher and more variable than bus ridership, reflecting differences in passenger volume and travel behavior across the whole period.",width=150)
  ) +
